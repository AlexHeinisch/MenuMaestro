package at.codemaestro.integration_test.ingredients;

import at.codemaestro.domain.ingredient.Ingredient;
import at.codemaestro.domain.ingredient.IngredientStatus;
import at.codemaestro.domain.organization.Organization;

import static at.codemaestro.integration_test.utils.test_constants.DefaultAccountTestData.*;
...
import static at.codemaestro.integration_test.utils.test_constants.DefaultIngredientTestData.*;
...
public class CustomIngredientsWebIntegrationTest extends BaseWebIntegrationTest{
    ...
    @BeforeEach
    public void setup() {
        Organization organization = organizationRepository.saveAndFlush(defaultOrganization1());
