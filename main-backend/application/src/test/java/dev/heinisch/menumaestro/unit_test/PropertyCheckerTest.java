package dev.heinisch.menumaestro.unit_test;
...
public class PropertyCheckerTest {
    ...
    void whenCheckString_andBlank_oneErrorMessage() {
        PropertyChecker.begin()
                ...
                .notBlank()
                .done()
                .finalize((lst) -> assertThat(lst).containsExactly("X cannot be blank"));
    }
    ...
    void whenCheckString_andTooShortNoEmail_someErrorMessage() {
        PropertyChecker.begin()
                ...
                .done()
                .finalize(
                        (lst) -> assertThat(lst).containsExactlyInAnyOrder(
                                "X is not an email",
    ...
    void whenCheckPositiveLong_withNegativeCheck_oneErrorMessage() {
        PropertyChecker.begin()
                ...
                .negative()
                .done()
                .finalize((lst) -> assertThat(lst).containsExactlyInAnyOrder("X is not negative"));
    }
    ...
    void whenCheckNegativeLong_withPositiveCheck_oneErrorMessage() {
        PropertyChecker.begin()
                ...
                .negative()
                .done()
                .finalize((lst) -> assertThat(lst).containsExactlyInAnyOrder("X is negative"));
    }
    ...
    void whenCheckNegativeInt_withPositiveCheck_oneErrorMessage() {
        PropertyChecker.begin()
                ...
                .negative()
                .done()
                .finalize((lst) -> assertThat(lst).containsExactlyInAnyOrder("X is not positive"));
    }
    ...
    void whenCheckIntList_withEmptyList_andEmptyCheck_oneErrorMessage() {
        ...
        PropertyChecker.begin()
                ...
                .notEmpty()
                .done()
                .finalize((lst) -> assertThat(lst).containsExactlyInAnyOrder("X is empty"));
    }
    ...
    void whenCheckIntList_withNullList_andNullCheck_oneErrorMessage() {
        ...
        PropertyChecker.begin()
                ...
                .notEmpty()
                .done()
                .finalize((lst) -> assertThat(lst).containsExactlyInAnyOrder("X is missing"));
    }
    ...
    void whenCheckIntListNested_withTwoElementList_andNegativeIntCheck_oneErrorMessage() {
        ...
        PropertyChecker.begin()
                ...
                .done()
                .finalize((lst) -> assertThat(lst).containsExactlyInAnyOrder("Y is not positive"));
    }
}
