    ...
    <nav class="bg-primary-800">
      <div class="mx-auto max-w-7xl px-2 md:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
          ...
          <div class="flex flex-row items-center">
            <div
              class="hidden md:flex-row md:flex md:items-center ml-auto text-sm"
            >
              <login-logout-button />
              <account-button />
            </div>
      ...
      @if (isMobileMenuOpen) {
        <div class="md:hidden" id="mobile-menu">
          <div
            class="flex flex-col items-center justify-center px-2 pb-3 pt-2 border-t border-gray-200"
          >
            <a
              routerLink="/recipes"
              [ngClass]="{ 'bg-primary-700': isActive('/recipes') }"
