    ...
    <div class="markdown-editor-container">
      ...
      @if (activeTab === "edit") {
        <div class="edit-tab">
          <!-- Formatting Toolbar -->
          <div
            class="flex flex-wrap gap-1 p-2 bg-gray-100 border border-gray-300 rounded-t items-center"
          >
            <button
              type="button"
            ...
            <div class="relative">
              <button
                ...
                class="toolbar-btn"
                (click)="
                  showEmojiPicker = !showEmojiPicker; showTooltip = false
                "
                title="Insert Emoji"
              >
                😀
              ...
              @if (showEmojiPicker) {
                ...
                >
                  ...
                  @for (category of filteredEmojiCategories; track category) {
                    <div class="mb-4">
                      ...
                      <div class="grid grid-cols-10 gap-1">
                        @for (emojiData of category.emojis; track emojiData) {
                          <button
                            type="button"
                  ...
                  @if (filteredEmojiCategories.length === 0) {
...
export class MarkdownEditorComponent implements ControlValueAccessor {
  ...
  onEmojiSearchChange(): void {
    this.filteredEmojiCategories = this.emojiService.searchEmojis(
      this.emojiSearchTerm,
    );
  }
}
