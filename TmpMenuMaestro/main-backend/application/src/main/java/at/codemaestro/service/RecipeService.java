...
import at.codemaestro.exceptions.ForbiddenException;
...
import static at.codemaestro.domain.recipe.RecipeVisibility.PUBLIC;
...
public class RecipeService {
    ...
    public RecipeDto createRecipe(RecipeCreateEditDto recipeCreateEditDto) {
        ...
        Recipe recipe = Recipe.builder()
                .visibility(at.codemaestro.domain.recipe.RecipeVisibility.valueOf(recipeCreateEditDto.getVisibility().getValue()))
    ...
    public Page<RecipeDto> getRecipes(
        ...
        return recipeRepository.findByMultipleValues(name, description, author, ingredientIds, cookingApplianceIds, visibility == null ? null : at.codemaestro.domain.recipe.RecipeVisibility.valueOf(visibility.getValue()), username, orgIds, isAdmin, pageable)
                .map(recipeMapper::toRecipeDto);
    }
    ...
    public RecipeDto editRecipeById(Long id, RecipeCreateEditDto recipeCreateEditDto) {
        ...
        recipe.setVisibility(at.codemaestro.domain.recipe.RecipeVisibility.valueOf(recipeCreateEditDto.getVisibility().getValue()));
